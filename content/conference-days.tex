...
%\section[Poster Session-A]{Poster Session-A}
...
\newpage
\input{auto/papers/Wednesday-Poster-Poster-Spotlight-A-(Half-minute-Madness)-abstracts.tex}


%\input{auto/papers/Wednesday-Poster-Poster-Session-A-abstracts.tex}
\input{auto/papers/Wednesday-Poster-Poster-Session-A-abstracts-withThemes.tex}
...
\newpage
\input{auto/papers/Thursday-Poster-Poster-Spotlight-B-(Half-minute-Madness)-abstracts.tex}
%\input{auto/papers/Thursday-Poster-Poster-Session-B-abstracts.tex}
\input{auto/papers/Thursday-Poster-Poster-Session-B-abstracts-withThemes.tex}
...
\input{auto/papers/Friday-Session-P4-abstracts.tex}