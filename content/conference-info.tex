...
\input{content/GCprefaceOct18.tex}
...
%\footnote{By the submission deadline we received 1,185 papers, but to compute the acceptance statistics we exclude 57 papers that were withdrawn (34 long and 23 short), and
...
\item Daniele Pighin, Google Inc. (advisor) \index{Pighin, Daniele} 
\end{itemize}
...
\begin{itemize}[nosep, leftmargin=0.5cm, label={}]
\item Jackie Chi Kit Cheung, McGill University \index{Cheung, Jackie Chi Kit}
\end{itemize}
...
\begin{itemize}[nosep, leftmargin=0.5cm, label={}]
\item Michael Collins, Columbia University and Google  \index{Collins, Michael}
\item    Liang Huang, Oregon State University  \index{Huang, Liang}
\item    Daisuke Kawahara, Kyoto University  \index{Kawahara, Daisuke}
\item    Andr{\'e} F.T. Martins, Unbabel and Instituto de Telecomunicações \index{Martins, Andr{\'e} F. T.}
\end{itemize}
...
\item    Georgiana Dinu, IBM Watson \index{Dinu, Georgiana}
\item    Edward  Grefenstette, Google DeepMind \index{Grefenstette, Edward}
...
\begin{itemize}[nosep, leftmargin=0.5cm, label={}]
\item Timothy Baldwin, University of Melbourne \index{Baldwin, Timothy}
...
\item    Vivi Nastase, University of Heidelberg  \index{Nastase, Vivi}
\item    David Smith, Northeastern University  \index{Smith, David}
\item    Joel Tetreault, Grammarly \index{Tetreault, Joel}
\end{itemize}
